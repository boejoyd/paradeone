...
import { createParade } from "./actions";
    ...
    <AppShell>
      <div className="mb-10">
        ...
        <p className="mt-4 max-w-2xl text-lg text-slate-300">
          Start a new parade by creating the event, basic timeline, and expected
          staging needs.
        </p>
      </div>

      <Card title="Parade Details">
        <form action={createParade} className="mt-6 grid gap-5">
