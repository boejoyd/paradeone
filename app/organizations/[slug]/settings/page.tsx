  ...
  return (
    <AppShell>
      ...
      <div className="space-y-6">
        ...
        <Card title={`Team members (${members?.length ?? 0})`}>
                  ...
                  >
                    <div>
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {isCurrentUser ? (
                          <span className="rounded-full border border-blue-500/50 bg-blue-500/10 px-2 py-0.5 text-xs font-semibold text-blue-200">
                            You
                          </span>
                        ) : null}
                      </div>
                    ...
                    {canManage ? (
                      <div className="flex flex-wrap items-end gap-2">
                        <form action={updateOrganizationMemberRole} className="flex items-end gap-2">
                          ...
                          <button
                            type="submit"
                            className="rounded-lg border border-slate-600 px-3 py-2 text-sm font-semibold text-slate-200 transition hover:border-blue-400 hover:text-white"
                          >
                            Save
                          </button>
                        </form>
                        ...
                        <form action={removeOrganizationMember}>
                          ...
                          <button
                            type="submit"
                            className="rounded-lg border border-red-500/60 px-3 py-2 text-sm font-semibold text-red-200 transition hover:bg-red-500/10"
                          >
                            Remove
                          </button>
                        </form>
        ...
        <Card title={`Pending invitations (${invites?.length ?? 0})`}>
          <div className="mt-4 space-y-3">
              ...
              invites.map((invite) => (
                ...
                >
                  ...
                  <form action={cancelOrganizationInvite}>
                    ...
                    <button
                      type="submit"
                      className="rounded-lg border border-slate-600 px-3 py-2 text-sm font-semibold text-slate-200 transition hover:border-red-400 hover:text-red-200"
                    >
                      Cancel invite
                    </button>
                  </form>
