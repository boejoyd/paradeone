      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-5xl flex-col">
        <div className="flex items-start justify-between gap-6">
          ...
          <div className="shrink-0">
            <Link
              href="/signup"
              className="inline-flex rounded-full border border-slate-600 bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-100 transition hover:border-blue-400 hover:bg-slate-700 hover:text-white"
            >
              Create Account
            </Link>
          </div>
